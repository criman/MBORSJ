...
{
    T16Nx->CON1.CAPL0 = TIM_CapInitStruct->TIM_CapCapl0;
    T16Nx->CON1.CAPL1 = TIM_CapInitStruct->TIM_CapCapl1;
...
{
    T32Nx->CON1.CAPL0 = TIM_CapInitStruct->TIM_CapCapl0;
    T32Nx->CON1.CAPL1 = TIM_CapInitStruct->TIM_CapCapl1;
...
/***************************************************************
  函数名：T16Nx_Reload_CAP1
  描  述：T16Nx捕捉1重载计数器是否使能
  输入值：T16Nx：T16Nx en：ENABLE/DISABLE
  输出值：无
  返回值：无
 ***************************************************************/
...
/***************************************************************
  函数名：T16Nx_Reload_CAP0
  描  述：T16Nx捕捉0重载计数器是否使能
  输入值：T16Nx：T16Nx en：ENABLE/DISABLE
  输出值：无
  返回值：无
 ***************************************************************/
...
/***************************************************************
  函数名：T32Nx_Reload_CAP1
  描  述：T32Nx捕捉1重载计数器是否使能
  输入值：T32Nx：T32Nx en：ENABLE/DISABLE
  输出值：无
  返回值：无
 ***************************************************************/
...
/***************************************************************
  函数名：T32Nx_Reload_CAP0
  描  述：T32Nx捕捉0重载计数器是否使能
  输入值：T32Nx：T32Nx en：ENABLE/DISABLE
  输出值：无
  返回值：无
 ***************************************************************/
...
void T16Nx_PWMOutConfig(T16N_TypeDef *T16Nx, T16Nx_PWMInitStruType *T16Nx_PWMInitStruct)
{
    ...
    T16Nx_PWM_MATBUFUP_Enable(T16Nx);                             //默认使能缓冲更新
}

void T16Nx_PWM_MATBUFUP_Enable(T16N_TypeDef *T16Nx)
{
    T16Nx->CON2.MATBUFUP = ENUM_ENABLE;
}

void T16Nx_PWM_MATBUFUP_Disable(T16N_TypeDef *T16Nx)
{
    T16Nx->CON2.MATBUFUP = ENUM_DISABLE;
}
