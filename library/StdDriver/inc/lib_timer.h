...
typedef struct
{
    TYPE_FUNCEN  TIM_CapCapl1;//捕捉1重载计数器
    TYPE_FUNCEN  TIM_CapCapl0;//捕捉0重载计数器
...
#define T16N4_Enable() (T16N4->CON0.EN = 1)
#define T16N5_Enable() (T16N5->CON0.EN = 1)
...
#define T16N4_Disable() (T16N4->CON0.EN = 0)
#define T16N5_Disable() (T16N5->CON0.EN = 0)
...
#define T16N4_ASYNCWR_Enable() (T16N4->CON0.ASYWEN = 1)
#define T16N5_ASYNCWR_Enable() (T16N5->CON0.ASYWEN = 1)
...
#define T16N4_ASYNCWR_Disable() (T16N4->CON0.ASYWEN = 0)
#define T16N5_ASYNCWR_Disable() (T16N5->CON0.ASYWEN = 0)
...
#define T16N4_PwmOut0_Enable() (T16N4->CON2.MOE0 = 1)
#define T16N5_PwmOut0_Enable() (T16N5->CON2.MOE0 = 1)
...
#define T16N4_PwmOut1_Enable() (T16N4->CON2.MOE1 = 1)
#define T16N5_PwmOut1_Enable() (T16N5->CON2.MOE1 = 1)
...
#define T16N4_PwmOut0_Disable() (T16N4->CON2.MOE0 = 0)
#define T16N5_PwmOut0_Disable() (T16N5->CON2.MOE0 = 0)
...
#define T16N4_PwmOut1_Disable() (T16N4->CON2.MOE1 = 0)
#define T16N5_PwmOut1_Disable() (T16N5->CON2.MOE1 = 0)
...
void T16Nx_PWM_MATBUFUP_Enable(T16N_TypeDef *T16Nx);
void T16Nx_PWM_MATBUFUP_Disable(T16N_TypeDef *T16Nx);
...
void T16Nx_SetTOP(T16N_TypeDef *T16Nx, uint16_t Value);
void T16Nx_Reload_CAP1(T16N_TypeDef *T16Nx, TYPE_FUNCEN en);
void T16Nx_Reload_CAP0(T16N_TypeDef *T16Nx, TYPE_FUNCEN en);
...
void T32Nx_Reload_CAP1(T32N_TypeDef *T32Nx, TYPE_FUNCEN en);
void T32Nx_Reload_CAP0(T32N_TypeDef *T32Nx, TYPE_FUNCEN en);
